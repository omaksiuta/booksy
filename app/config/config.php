...
$config['sess_save_path'] = FCPATH . 'app/cache/';
...
$config['csrf_exclude_uris'] = array('upload-summernote-image');
...
$config['root_url'] = $config['base_url'];
...
$config['admin_url'] = $config['assets_url'] . 'admin/';
