<?php
$admin_id = (int) $this->session->userdata('staff_id');
$this->db->select('*');
$this->db->where('id', $admin_id);
$login_user_details = $this->db->get('app_admin')->row_array();
$folder_name="staff";
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="main-wrapper">
    ...
    <div class="header">
        ...
        <div class="header-left">
            <a href="<?php echo base_url('staff/dashboard'); ?>" class="logo">
                <img src="<?php echo get_CompanyLogo(); ?>" alt="<?php echo get_CompanyName(); ?>">
            </a>
            <a href="<?php echo base_url('staff/dashboard'); ?>" class="logo logo-small mt-2"><h3><?php echo mb_substr(get_CompanyName(), 0, 1, 'utf-8'); ?></h3></a>
        </div>
        <!-- /Logo -->
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="<?php echo base_url('staff/profile'); ?>"><?php echo translate('profile'); ?></a>
                    <a class="dropdown-item" href="<?php echo base_url('staff/change-password'); ?>"><?php echo translate('change_password'); ?></a>
                    <a class="dropdown-item" href="<?php echo base_url('staff/logout'); ?>"><?php echo translate('logout'); ?></a>
                </div>
            </li>
            <!-- /User Menu -->
    ...
    <?php include VIEWPATH . 'staff/sidebar.php';?>
