        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-7 col-auto">
                    <h3 class="page-title"><?php echo translate('manage') . " " . translate('appointment'); ?></h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('staff/dashboard'); ?>"><?php echo translate('dashboard'); ?></a></li>
                        <li class="breadcrumb-item"><a href="<?php echo base_url('staff/appointment'); ?>"><?php echo translate('appointment'); ?></a></li>
                    </ul>
                </div>
                <div class="col-sm-5 col">
                    <a href="<?php echo base_url('staff/add-appointment'); ?>" class="btn btn-primary float-right mt-2"><?php echo translate('add'); ?> <?php echo translate('appointment'); ?></a>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <table class="table table-bordered booking_datatable mdl-data-table" id="example">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo translate('payment'); ?></th>
