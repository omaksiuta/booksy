<?php
$login_user_details=get_VendorDetails();
$folder_name = 'admin';
...
<div class="main-wrapper">
    ...
    <div class="header">
        ...
        <div class="header-left">
            <a href="<?php echo base_url($folder_name.'/dashboard'); ?>" class="logo">
                <img src="<?php echo get_CompanyLogo(); ?>" alt="<?php echo get_CompanyName(); ?>">
            </a>
            <a href="<?php echo base_url($folder_name.'/dashboard'); ?>" class="logo logo-small mt-2"><h3><?php echo mb_substr(get_CompanyName(), 0, 1, 'utf-8'); ?></h3></a>
        </div>
        <!-- /Logo -->
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="<?php echo base_url('vendor/profile'); ?>"><?php echo translate('profile'); ?></a>
                    <a class="dropdown-item" href="<?php echo base_url('vendor/change-password'); ?>"><?php echo translate('change_password'); ?></a>
                    <a class="dropdown-item" href="<?php echo base_url('vendor/logout'); ?>"><?php echo translate('logout'); ?></a>
                </div>
            </li>
            <!-- /User Menu -->
    ...
    <?php include VIEWPATH . 'vendor/sidebar.php';?>
