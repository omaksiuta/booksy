            ...
            <div class="col-lg-4 col-md-7 mx-md-auto my-4">
                ...
                <div class="card my-3">
                    ...
                    <div class="card-body resp_mx-0">
                        ...
                        echo form_open('vendor/reset-password-action', $attributes, $hidden);
                        ?>
                        <div class="form-group">
                            <label for="password"> <?php echo translate('password'); ?> <small class="required">*</small></label>
                            <input type="password" required="" id="password" name="password"  autocomplete="off" value="" class="form-control" placeholder="<?php echo translate('password'); ?>">                                
                        ...
                        <div class="row">
                            ...
                            <div class="n_page-redirect col-6 col-md-6 text-right">
                                <p class="mt-3"> <?php echo translate('now'); ?> <a href="<?php echo base_url("vendor/login"); ?>" class="dark-grey-text ml-1 font-bold"> <?php echo translate('login'); ?></a></p>
                            </div>
                        </div>
                        <!--Grid row-->
                        <?php echo form_close(); ?>
