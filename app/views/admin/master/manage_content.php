        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-5 col">
                    <a href="<?php echo base_url($folder_name.'/add-content'); ?>" class="btn btn-primary float-right mt-2"><?php echo translate('add'); ?> <?php echo translate('content_management'); ?></a>
                </div>
            </div>
        </div>
        <div class="row">
                                    ...
                                    foreach ($app_faq as $key => $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-actions text-center">
                                                <a href="<?php echo base_url('admin/update-content/' . $row['id']); ?>" class="btn btn-sm bg-primary-light" title="<?php echo translate('edit'); ?>" data-toggle="tooltip" data-placement="top"><i class="fe fe-pencil"></i></a>
