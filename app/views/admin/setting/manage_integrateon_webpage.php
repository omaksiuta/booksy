        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-7 col-auto">
                    <h3 class="page-title"><?php echo translate('integrateon_webpage'); ?> <?php echo translate('setting'); ?></h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url($folder_name.'/dashboard'); ?>"><?php echo translate('dashboard'); ?></a></li>
                        <li class="breadcrumb-item"><a href="<?php echo base_url($folder_name.'/integrateon-webpage'); ?>"><?php echo translate('integrateon_webpage'); ?> <?php echo translate('setting'); ?></a></li>
                    </ul>
                </div>
