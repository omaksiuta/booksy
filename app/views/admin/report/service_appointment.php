        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-7 col-auto">
                    <h3 class="page-title"><?php echo translate('service') . " " . translate('appointment') . " " . translate('report'); ?></h3>
                    <ul class="breadcrumb">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="">
                            <form class="form" role="form" method="GET" id="appointment_filter" >
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <select name="event" id="event" class="form-control" onchange="this.form.submit();" style="display: block !important">
                                                <option value=""><?php echo translate('all') ?> <?php echo translate('service') ?></option>
                                    ...
                                    <div class="col-md-1">
                                        <a class="btn btn-info btn-sm" href="<?php echo base_url($folder_name . '/service-appointment-report') ?>"><i class="fa fa-refresh"></i></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered  mdl-data-table">
                                <thead>
                                <tr>
