            ...
            <div class="row">
                <div class="col-sm-7 col-auto">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url($folder_name.'/manage-appointment'); ?>"><?php echo translate('appointment'); ?></a></li>
                    </ul>
                </div>
                <div class="col-sm-5 col">
                    <a href="<?php echo base_url($folder_name.'/add-appointment'); ?>" class="btn btn-primary float-right mt-2"><?php echo translate('add'); ?> <?php echo translate('appointment'); ?></a>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table booking_datatable table-bordered mdl-data-table" id="example">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center"><?php echo translate('staff'); ?></th>
