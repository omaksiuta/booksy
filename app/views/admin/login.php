            ...
            <div class="container">
                <div class="loginbox">
                    <div class="login-left">
                        <a href="<?php echo base_url(); ?>"><img class="img-fluid" src="<?php echo get_CompanyLogo(); ?>" alt="<?php echo get_CompanyName(); ?>"></a>
                    </div>
                    <div class="login-right">
                        <div class="login-right-wrap">
                            <h1><?php echo translate('login'); ?></h1><br/>
                            ...
                            <div class="text-center forgotpass">
                                <a href="<?php echo base_url("admin/forgot-password"); ?>"><?php echo translate('forgot_password'); ?>?</a>
                            </div>
