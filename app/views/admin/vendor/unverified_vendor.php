            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-7 col-auto">
                        <h3 class="page-title"><?php echo translate('unverified')." ".translate('vendor'); ?></h3>
                        <ul class="breadcrumb">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-actions text-center">
                                                    <span class="d-inline-block" title="<?php echo translate('update') . " " . translate('status'); ?>" data-toggle="tooltip" data-placement="top">
                                                        <a id="" data-toggle="modal" onclick='ChangeStatus(this)' data-target="#change-status" data-id="<?php echo (int) $row['id']; ?>" class="btn btn-sm bg-info-light"><i class="fe fe-eye"></i></a>
                                                    </span>
                                                </td>
                                            </tr>
                                            <?php
