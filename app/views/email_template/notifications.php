                                            ...
                                            <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p style="font-size:15px; color:#171f23de; line-height:24px; margin:8px 0 30px;"><?php echo translate('appointment_delete_notification_vendor'); ?></p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #ededed">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);" ><?php echo convertToHoursMins($event_data['slot_time']); ?></td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);"><?php echo isset($booking_date) ? $booking_date : ""; ?></td>
                                                                </tr>
                                                                <tr>
