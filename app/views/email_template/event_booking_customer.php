                                            ...
                                            <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p style="font-size:15px; color:#171f23de; line-height:24px; margin:8px 0 30px;"><?php echo translate('new_event_booking'); ?><b><?php echo $event_data['title']; ?></b></p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #ededed">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td style="padding: 10px;  border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%;font-weight:500; color:#171f23de"><?php echo translate('organizer'); ?></td>
                                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">
                                                                        <p><b><?php echo isset($event_data['company_name']) ? $event_data['company_name'] : ""; ?></b></p>
                                                                        <?php if (isset($event_data['address']) && $event_data['address'] != ""): ?>
                                                                            <p><b><?php echo translate('address'); ?>:</b><?php echo isset($event_data['address']) ? $event_data['address'] : ""; ?></p>
                                                                        <?php else: ?>
                                                                            <p><b><?php echo translate('address'); ?>:</b><?php echo isset($event_data['vendor_address']) ? $event_data['vendor_address'] : ""; ?></p>
                                                                        <?php endif; ?>
                                                                        <p><b><?php echo translate('phone'); ?>:</b><?php echo isset($event_data['phone']) ? $event_data['phone'] : ""; ?></p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
