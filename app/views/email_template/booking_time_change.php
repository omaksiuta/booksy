                                            ...
                                            <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p style="font-size:15px; color:#171f23de; line-height:24px; margin:8px 0 30px;"><?php echo translate('appointment_time_update'); ?></p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #ededed">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);"><?php echo isset($SERVICE_TIME) ? $SERVICE_TIME : ""; ?></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <?php if (isset($staff_data) && $staff_data['id'] > 0): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">
                                                                            <p><b><?php echo isset($staff_data['first_name']) ? $staff_data['first_name'] . ' ' . $staff_data['last_name'] : ""; ?></b></p>
                                                                            <p><b><?php echo isset($staff_data['designation']) ? $staff_data['designation'] : ""; ?></b></p>
                                                                        </td>
                                                                    </tr>
                                                                <?php endif; ?>
