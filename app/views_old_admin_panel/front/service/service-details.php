...
<div class="service_details_content">
    ...
    <div class="service_header_title">           
        <div class="container">
            <div class="text-left">
                <h2 class="blue-grey-text"><?php echo (trim($event_data['title'])); ?></h2>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane fade in show active" id="details" role="tabpanel">
                                                        <div class="event-details-text">
                                                            <?php echo htmlspecialchars_decode($event_data['description']); ?>
                                                        </div>
                                                    </div>
                                                    <!--/.Panel 1-->
                    ...
                    <div class="col-md-4 right-sidebar-section">
                                ...
                                <div class="user_details">
                                    <div class="text-center">
                                        ...
                                        <div class="user_details-info">
                                            ...
                                            <?php } ?>
                                            <div class="gobtn">
                                                <a class="btn text-capitalize" href="<?php echo base_url('v/' . slugify(trim($admin_data['company_name'])) . '/' . $admin_data['id']); ?>"><?php echo translate('go_to_profile_page'); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="purchase-button btn_list my-1">
                            <a href="<?php echo base_url('day-slots/' . $event_data['id']); ?>" class="btn btn-dark button_common btn-lg w-100 mx-0 text-center mt-1 mb-1">
                                ...
                                <div class="tab-content" id="profiletabControl">
                                    ...
                                    <div class="tab-pane fade" id="c_small_form" role="tabpanel" aria-labelledby="c_small_form-tab">
                                        <div class="small-form">
                                            ...
                                            echo form_hidden("event_category_id", $this->uri->segment(2));
                                            echo form_hidden("event_id", $this->uri->segment(3));
                                            ...
                                            <div class="form-group">
                                                <input class="form-control"  maxlength="50" required=""  autocomplete="off" type="email" placeholder="<?php echo translate('email'); ?>" id="emailid" name="emailid" />
                                                <?php echo form_error('emailid'); ?>
                                            </div>
                                            <div class="form-group">
                                                <input required="" maxlength="15" class="form-control phone" autocomplete="off"  type="text" placeholder="<?php echo translate('phone'); ?>" id="phoneno" name="phoneno" />
