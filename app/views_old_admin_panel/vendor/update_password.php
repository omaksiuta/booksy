            ...
            <section class="form-light px-2 sm-margin-b-20 ">
                ...
                <div class="card">
                    <div class="card-body resp_mx-0">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-success waves-effect" style="margin-top: 25px;"><?php echo translate('update'); ?></button>
                        </div>
                        <?php echo form_close(); ?>
                    </div>
                </div>
...
<!-- Custom Script --><script src="<?php echo $this->config->item('js_url'); ?>module/vendor_content.js" type="text/javascript"></script>
