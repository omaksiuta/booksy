            ...
            <div class="col-lg-4 col-md-7 mx-md-auto my-0">
                ...
                <div class="card my-4">
                    ...
                    <div class="card-body mt-4 resp_mx-0">
                        ...
                        echo form_open('staff/forgot-password-action', $attributes);
                        ?>
                        ...
                        <div class="row">
                            ...
                            <div class="text-right col-6 col-md-6">
                                <p class="mt-3"><?php echo translate('return'); ?> <a href="<?php echo base_url("staff/login"); ?>" class="dark-grey-text ml-1 font-bold"> <?php echo translate('login'); ?></a></p>
                            </div>
                        </div>
                        <!--Grid row-->
                        <?php echo form_close(); ?>
