        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-7 mx-md-auto my-4">
                ...
                <div class="card my-3">
                    <!--Header-->
                    <div class="header">
                        <h3 class="text-center my-3"><?php echo translate('staff')." ".translate('login'); ?></h3>
                    </div>
                    <!--Header-->
                    ...
                    <div class="card-body mt-4 resp_mx-0">
                        ...
                        echo form_open('staff/login-action', $attributes);
                        ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-6 text-right">
                                <p class="mt-3"> <a href="<?php echo base_url("staff/forgot-password"); ?>" class="dark-grey-text ml-1 font-bold"><?php echo translate('forgot_password'); ?>?</a></p>
                            </div>
                        </div>
                        <!--Grid row-->
                        <?php echo form_close(); ?>
