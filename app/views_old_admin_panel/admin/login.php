                    ...
                    <div class="card mt-3">
                        ...
                        <div class="p-4 resp_mx-0">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" autocomplete="off"  placeholder="<?php echo translate('password'); ?>" id="password" name="password" class="form-control">                                
                                <?php echo form_error('password'); ?>
                            </div>
                            <!--Grid row-->
                            <div class="row d-flex align-items-center">
                                <div class="col-md-1 col-md-5">
                                    <button type="submit" class="btn btn-blue-grey btn-rounded"><?php echo translate('login'); ?></button>
                                </div>
                                <div class="col-md-7 text-right">
                                    <p class="font-small grey-text"> <a href="<?php echo base_url("admin/forgot-password"); ?>" class="dark-grey-text ml-1 font-bold"><?php echo translate('forgot_password'); ?>?</a></p>
                                </div>
                            </div>
                            <!--Grid row-->
                            <?php echo form_close(); ?>
