                                            ...
                                            if (isset($payment_data) && count($payment_data) > 0) {
                                                foreach ($payment_data as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo ucfirst($row['company_name']); ?></td>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?php echo base_url('event-payment-details/' . (int) $row['id']); ?>"  data-direction="right" class="btn btn-info font_size_12 bookslide" title="<?php echo translate('view_details'); ?>"><?php echo translate('details'); ?></a>
...
<script>
    ...
    $("#UpdateStatusBtn").on("click", function (e) {
        ...
        if (UpdateRecordForm == true) {
            ...
            $.ajax({
                url: base_url + folder_name + "/payment_status_update/" + record_id,
                type: "post",
                data: formData,
                beforeSend: function () {
                    $("body").preloader({
