                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <select name="event" id="event" class="form-control" onchange="change_filter()" style="display: block !important">
                                                        <option value=""><?php echo translate('event') ?></option> 
                                                    ...
                                                    <div class="form-group">
                                                        <select name="vendor" id="vendor" class="form-control" onchange="change_filter()" style="display: block !important">
                                                            ...
                                                            <?php foreach ($appointment_vendor as $val): ?>
                                                                <option <?php echo (isset($_REQUEST['vendor']) && $_REQUEST['vendor'] == $val['id']) ? "selected='selected'" : ""; ?> value="<?php echo $val['id'] ?>"><?php echo ucfirst($val['company_name']); ?></option> 
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                                    ...
                                    <table class="table mdl-data-table" id="example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center font-bold dark-grey-text"><?php echo translate('event') . " " . ('date'); ?></th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            if ($created_by == $row['created_by']) {
                                                                if ($row['status'] != 'C') {
                                                                    ?>
                                                                    <a id="" data-toggle="modal" data-status='<?php echo $row['status']; ?>' onclick='AppointmentAction(this)' data-target="#appointment-record" data-id="<?php echo (int) $row['id']; ?>" class="btn-floating btn-sm blue-gradient" title="<?php echo translate('appointment_action'); ?>"><i class="fa fa-eye"></i></a>
...
<div class="modal fade" id="remainder-appointment">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button  class="btn btn-danger font_size_12" type="button" onclick="send_mail(this);"><?php echo translate('yes'); ?></button>
                <button data-dismiss="modal" class="btn btn-primary font_size_12" type="button"><?php echo translate('no'); ?></button>
            </div>
            </form>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
