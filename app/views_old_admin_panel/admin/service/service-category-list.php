                                                        ...
                                                        <td class="td-actions text-center">
                                                            ...
                                                            if ($this->session->userdata('Type_' . ucfirst($this->uri->segment(1))) == 'V') {
                                                                ...
                                                                if ($created_by == $row['created_by']) {
                                                                    ?>
                                                                    <a href="<?php echo base_url('vendor/update-service-category/' . $row['id']); ?>" class="btn btn-primary font_size_12" title="<?php echo translate('edit'); ?>"><i class="fa fa-pencil"></i></a>
                                                                ...
                                                                ?>
                                                                <a href="<?php echo base_url('admin/update-service-category/' . $row['id']); ?>" class="btn btn-primary font_size_12" title="<?php echo translate('edit'); ?>" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil"></i></a>
