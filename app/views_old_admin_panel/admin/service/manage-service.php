                ...
                <div class="row">
                    <div class="col-md-12 m-auto">
                        ...
                        <div class="header bg-color-base p-3">
                            <h3 class="black-text font-bold mb-0"><?php echo isset($id) && $id > 0 ? translate('update') : translate('add'); ?> <?php echo translate('service'); ?></h3>
                        </div>
                            ...
                            <div class="card-body resp_mx-0">
                                <div class="steps-form-2">
                                    <div class="steps-row-2 setup-panel-2 d-flex justify-content-between">
                                        ...
                                        <div class="steps-step-2">
                                            <a href="#step-2" type="button" class="btn btn-blue-grey waves-effect" data-toggle="tooltip" data-placement="top" title="<?php echo translate('booking') . " " . translate('setting'); ?>">
                                                <?php echo translate('booking') . " " . translate('setting'); ?>
                                            </a>
                                        </div>
                                        <div class="steps-step-2">
                                            <a href="#step-3" type="button" class="btn btn-blue-grey waves-effect" data-toggle="tooltip" data-placement="top" title="<?php echo translate('Price'); ?>">
                                                <?php echo translate('price'); ?>
                                            </a>
                                        </div>
                                        <div class="steps-step-2">
                                            <a href="#step-4" type="button" class="btn btn-blue-grey waves-effect" data-toggle="tooltip" data-placement="top" title="<?php echo translate('media'); ?>">
                                                <?php echo translate('media'); ?>
                                            </a>
                                        </div>

                                        <div class="steps-step-2">
                                            <a href="#step-5" type="button" class="btn btn-blue-grey waves-effect" data-toggle="tooltip" data-placement="top" title="<?php echo translate('service') . " " . translate('faqs'); ?>">
                                                <?php echo translate('service') . " " . translate('faqs'); ?>
                                            </a>
                                        </div>
                                        <div class="steps-step-2">
                                            <a href="#step-6" type="button" class="btn btn-blue-grey waves-effect" data-toggle="tooltip" data-placement="top" title="<?php echo translate('seo'); ?>">
                                ...
                                <div class="row setup-content-2" id="step-1">
                                    <div class="col-md-12">
                                        <h3 class="font-bold pl-0 my-4"><strong><?php echo translate('service'); ?> <?php echo translate('information'); ?></strong></h3>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select tabindex="2" class="kb-select initialized" id="days" name="category_id"> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select tabindex="4" class="kb-select initialized" id="city" name="city" onchange="get_location(this.value);"> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select tabindex="5" class="kb-select initialized" id="location" name="location"> 
                                ...
                                <div class="row setup-content-2" id="step-description">
                                    <div class="col-md-12">
                                        <h3 class="font-bold pl-0 my-4"><strong><?php echo translate('service'); ?> <?php echo translate('description'); ?></strong></h3>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                ...
                                <div class="row setup-content-2" id="step-2">
                                    <div class="col-md-12">
                                        <h3 class="font-bold pl-0 my-4"><strong><?php echo translate('booking'); ?> <?php echo translate('setting'); ?></strong></h3>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group" id="image-data">
                                                    <label for="image"> <?php echo translate('service') . " " . translate('image'); ?> <small class="required">*</small></label><button type="button" class="btn blue-gradient waves-effect success-color btn-sm float-right" onclick="get_more_image(this);"><i class="fa fa-plus-square-o mr-10"></i><?php echo translate('more'); ?></button>
