        ...
        <div class="container-fluid">
            <section class="form-light px-2 sm-margin-b-20 ">
                ...
                <div class="header bg-color-base p-3">
                    <h3 class="black-text font-bold mb-0"><?php echo isset($id) && $id > 0 ? translate('update') : translate('add'); ?> <?php echo translate("service") . " " . translate('category'); ?></h3>
                </div>
                ...
                <div class="card">
                    <div class="card-body resp_mx-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="title" class="mt-2"> <?php echo translate('event_category_image'); ?>  (Image size must be 40X40.)<small class="required">*</small></label><br/>
