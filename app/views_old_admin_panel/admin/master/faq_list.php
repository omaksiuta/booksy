                        ...
                        <div class="header bg-color-base p-3">
                            <div class="row">
                                <span class="col-md-9 col-9 m-0">
                                    <h3 class="black-text font-bold mb-0"><?php echo translate('manage'); ?> <?php echo translate('faqs'); ?></h3>
                                </span>  
                                <span class="col-md-3 col-3 text-right m-0">
                                     <a title="<?php echo translate('add') . " " . translate('faqs'); ?>" href='<?php echo base_url('admin/add-faq'); ?>' class="btn-floating btn-sm btn-success m-0"><i class="fa fa-plus-circle"></i></a>
                                </span>
                            </div>
                        </div>
                                                ...
                                                foreach ($app_faq as $key => $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-center">
                                                            <a href="<?php echo base_url('admin/update-faq/' . $row['id']); ?>" class="btn btn-primary font_size_12" title="<?php echo translate('edit'); ?>" data-toggle="tooltip" data-placement="top"><i class="fa fa-pencil"></i></a>
