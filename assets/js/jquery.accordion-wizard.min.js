    ...
    a.extend(c.prototype, {
        init: function() {
            ...
            this.$steps = a("[data-acc-step]"), this.stepHeight = a("[data-acc-step]").eq(0).outerHeight(), this.settings.stepNumbers && this.$steps.each(function(t, e) {
                ...
                if (0 < t && s.append('<a href="javascript:void(0)" class="' + i.settings.autoButtonsPrevClass + '" data-acc-btn-prev>Back</a>'), t < i.$steps.length - 1) s.append('<a href="javascript:void(0)" class="' + i.settings.autoButtonsNextClass + '" data-acc-btn-next>Next</a>');
            ...
            }), this.currentIndex = this.settings.start - 1, "wizard" == this.settings.mode ? (this.activateStep(this.currentIndex, !0), a("[data-acc-btn-next]").on("click", function() {
            ...
            })) : "edit" == this.settings.mode && (this.activateAllSteps(), a("[data-acc-btn-next]").hide(), a("[data-acc-btn-prev]").hide()), a(this.element).on("submit", function(t) {
        ...
        activateStep: function(t, e) {
            ...
            !e && this.settings.enableScrolling && a("html").animate({
                scrollTop: this.$steps.eq(this.currentIndex).offset().top + (s - this.settings.scrollPadding)
            }, 500), a("[data-acc-content]", this.element).slideUp(), this.$steps.eq(t).addClass("open").find("[data-acc-content]").slideDown(), this.currentIndex = t
        },
